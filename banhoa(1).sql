...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2024 at 02:42 PM
...
(0, 0, '2024-11-01 01:42:42', 0, 0),
(1, 0, '2024-10-29 17:26:13', 600000, 1),
(2, 100, '2024-10-31 01:55:26', 0, 0),
(3, 4, '2024-11-01 12:21:51', 1700000, 1),
(4, 4, '2024-11-01 12:28:55', 2900000, 1),
(5, 4, '2024-11-01 12:40:47', 0, 0);
...
(10, 0, 'Thắng Phạm', '1', 'boymediumpmt@gmail.com', 'admin, vĩnh hưng, hoàng mai, Hà nội'),
(11, 2, 'Duy Phi', '1234567890', 'highlawview.pd@gmail.com', '218 Lĩnh Nam, vĩnh hưng, hoàng mai, HaNoi'),
(12, 3, 'Duy Phi', '1234567890', 'highlawview.pd@gmail.com', '218 Lĩnh Nam, vĩnh hưng, hoàng mai, HaNoi');
...
(0, 'duy', 'duy', 'highlawview.pd@gmail.com', '0123456789', 'Hanoi', 'duy'),
(2, 'admin', 'admin', 'admin@gmail.com', '81712831', 'admin', 'admin'),
(3, 'MT', 'MT', 'mT@gaga', '4121', 'MT', 'MT'),
(4, 'alex', 'Alex', 'alex@gmail.com', '1234567890', '218 Lĩnh Nam', 'alex');
...
INSERT INTO `lienhe` (`MaLienHe`, `HoTen`, `Email`, `TieuDe`, `NoiDung`, `NgayLienHe`) VALUES
(0, 'pham minh thang', 'boymediumpmt@gmail.com', '21312', 'adhjadajs', '2024-10-31');
...
(1, 1, 'Thanh toán khi nhận hàng', '2024-11-01 01:42:42', 600000, 'Đã Thanh Toán'),
(2, 3, 'Thanh toán khi nhận hàng', '2024-11-01 12:28:55', 1700000, 'Đã Thanh Toán'),
(3, 4, 'Thanh toán khi nhận hàng', '2024-11-01 12:40:47', 2900000, 'Đã Thanh Toán');
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `MaChiTietDonHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `giaohang`
--
ALTER TABLE `giaohang`
  MODIFY `MaGiaoHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
